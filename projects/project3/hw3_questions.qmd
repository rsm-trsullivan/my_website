...
for ax, grp, color, label in [
    ...
    ax.set_title(label, fontsize=12, fontweight="light")
    ax.legend(frameon=False, fontsize=9)
    sns.despine(ax=ax)

plt.suptitle("Distribution of Patent Counts by Customer Status",
             fontsize=13, fontweight="light", y=1.02)
plt.tight_layout()
plt.show()
```
...
#| echo: false
#| label: fig-ate
#| fig-cap: "Distribution of firm-level treatment effects — the difference in predicted patent count between the Blueprinty-customer and non-customer scenarios for each firm, holding age and region fixed. The green dashed line marks the Average Treatment Effect (ATE)."
#| fig-width: 8
#| fig-height: 4
